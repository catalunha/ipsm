...
void main(List<String> arguments) {
  ...
  var pedidoElegibilidade = PedidoElegibilidade(
  ...
  var elegibilidadeVerificaElegibilidade = ElegibilidadeVerificaElegibilidade(
    cabecalho: cabecalho,
    pedidoElegibilidade: pedidoElegibilidade,
  );
  print(elegibilidadeVerificaElegibilidade.toJson());
  // senhaIpsm();
